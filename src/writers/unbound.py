"""Unbound DNS host-override CRUD.

Endpoints (`/api/unbound/settings/*`) follow the same shape as filter rules:
addHostOverride / setHostOverride / delHostOverride / searchHostOverride,
with `service/reconfigure` to commit. Verified live against OPNsense 26.1.2
(2026-05-10): addHostOverride → uuid → delHostOverride round-trip OK.

Scope of v1.5.0: host overrides only. Domain overrides ship in a follow-up.
"""
